...
/***/ function(module, exports, __webpack_require__) {
	...
	body[0].addEventListener('click', function (e) {
	    _classNames2.default.removeClass(dropdown.parentNode, 'dropdown--active');
	});
	...
	var RelatedIcons = _react2.default.createClass({
	  ...
	  render: function render() {
	    var _props = this.props,
	        icons = _props.icons,
	        activeCategoryName = _props.activeCategoryName;
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(_IconList2.default, { icons: icons })
	    );
	  }
	});
